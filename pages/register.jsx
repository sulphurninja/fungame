...
function register() {
    const initialState = { userName: '', password: '', role: '', balance: 0 }
    const [userData, setUserData] = useState(initialState)
    const { userName, password, role, balance } = userData
    ...
    return (
        <body className='bg-black overflow-y- h-screen '>
            ...
            <div className="w-full scale-75  max-w-xs flex  justify-center z-20 ml-auto mr-auto items-center absolute">
                <form className="bg-white shadow-md rounded px-8 pt-2 pb-2 mb-4" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-6">
                        ...
                        <input className="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="role" type="number" name='balance' value={balance} onChange={handleChangeInput} placeholder="Enter Balance" />
